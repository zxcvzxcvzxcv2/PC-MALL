			...
			<table width="480" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td bgcolor="#0000ff" height="28">
						<div align="center">
							<font color="#ffffff"><b>ID 찾기</b></font>
						</div>
					</td>
				</tr>
				<tr bgcolor="#ffffff">
					<td align=center bgcolor="#eff4f8" height="120">
						<table width="250" border="0" cellspacing="0" cellpadding="1">
							<tr>
								<td width="55" nowrap>이름</td>
								<td width="175"><input type=text name="name" size="16" 
									maxlength=16 style="width:155" ></td>
							</tr>
							<tr>
								<td width="55"nowrap>이메일</td>
								<td width="175"><input type=text name="email" size="14"
								 maxlength="30" style="width:155" ></td>
							</tr>
