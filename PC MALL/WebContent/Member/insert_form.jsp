...
<body bgcolor="#eeeee0">
	...
	<table border=1 cellpadding=2 cellspacing=0 width=550 valign=top align=center>
		<tr>
		...
		<tr>
			...
			<td><input type=password name=repwd size=8 maxlength=12 value="">&nbsp다시 한번 입력해 주세요. </td>
		</tr>
		<tr>
		<tr>
