    ...
    <div>
        <form action="sendMail.jsp" method="post">
            <table width="550" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr><td width=120 align=center bgcolor="#7eaee9">전화번호</td><td><input type="text" name="number"></td></tr>
                <tr><td width=120 align=center bgcolor="#7eaee9">고객 이메일</td><td><input type="text" name="email"></td></tr>
                <tr><td width=120 align=center bgcolor="#7eaee9">신고 제목</td><td><input type="text" name="reportTitle" /></td></tr>
                <tr><td width=120 align=center bgcolor="#7eaee9">신고 내용</td><td><textarea name="reportContent" cols=58 rows=15;"></textarea></td></tr>
