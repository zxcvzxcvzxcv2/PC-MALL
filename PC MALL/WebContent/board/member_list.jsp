...
<br>
	<table border=1 width=550 height=30 bordercolor=black>
		<tr>
			<td align=center bgcolor=0063ce><font size=3 color=#FFFFFF><b>회 원 전 용 게 시 판</b></td>
		</tr>
	</table>
	<br>
...
<%   
	try{ 
		...
		ResultSet pageset = stmt.executeQuery("select count(b_id) from member_board");
		if( pageset.next()){
		...
		sql = sql + " from member_board order by ref desc, step ";
...
<%
			...
			if ((startPage+limit)<=pagecount){ %>
  				<a href='member_list.jsp?pageNUM=<%=startPage+limit%>'>[다음] <a>
<%
			}
%>
			</td>
			...
			<a href="member_list.jsp"><img src="img/m_bt06.gif" border=0 align=absmiddle></a>
			</td>
			<td width=10>&nbsp;</td>
		</tr>
	</table>
